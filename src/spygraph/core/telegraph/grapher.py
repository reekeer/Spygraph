...
class Grapher(Telegraph):
    ...
    def create_grabber_page(
        ...
        **kwargs,
        ...
        if not content_file_path and not track_url:
            ...
            if "return_content" in passthrough_kwargs:
                passthrough_kwargs["return_content"] = bool(passthrough_kwargs["return_content"])

            return super().create_page(**passthrough_kwargs)

        if not content_file_path or not track_url:
            raise ValueError("Both content_file_path and track_url are required")
        ...
        page_args = self._build_page_args(
            page_title,
            final_content,
            author,
            author_url,
        ...
        page = super().create_page(**page_args, return_content=False)
    ...
    def create_graph_account(
        ...
        account_data = {"short_name": short_name}
